...
class InfoFragment : Fragment() {
    ...
    @SuppressLint("MissingInflatedId", "CutPasteId", "ResourceType")
    ...
    override fun onCreateView(
        ...
        btn_contacts.setOnClickListener {
            ...
            var dialog_view: View? = dialogBining
...
//                }
            ...
            cancel_btn.setOnClickListener {
                ...
                root_view.findViewById<ImageView>(R.id.info_logo).setImageResource(getResources().getIdentifier("logofaculty","drawable",context.getPackageName()))
...
//                    }
                ...
                if(tempArraylist.isEmpty()){
                    tempArraylist.add(FacultiesModel(logo="sad",name="Збігів не знайдено"))
                }
